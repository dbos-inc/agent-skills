...
- Cancellation happens at the **beginning of the next step** - the current step completes first, unless it observes `DBOS.stepStatus.cancelSignal` (5.1+) and stops early (see `step-timeouts.md`)
